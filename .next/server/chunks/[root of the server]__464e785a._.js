...
"[project]/.next-internal/server/app/api/auth/profile/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function PUT(req) {
    try {
        ...
        if (newPassword && currentPassword) {
            ...
            const isPasswordValid = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["compare"])(currentPassword, user.password);
            if (!isPasswordValid) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            // Hash new password
            updateData.password = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["hash"])(newPassword, 10);
        }
        // Update user
        const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
            where: {
                id: session.user.id
            },
            data: updateData,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__464e785a._.js.map