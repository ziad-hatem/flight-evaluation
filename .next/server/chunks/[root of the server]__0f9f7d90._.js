...
"[project]/.next-internal/server/app/api/ratings/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/ratings/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const ratings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].rating.findMany({
            where,
            include: {
                user: {
                    select: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(ratings);
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        const { flightId, checkIn, boardingExp, cabinCrew, seatComfort, foodQuality, entertainment, flightPerf, valueForMoney, overallRating } = body;
        ...
        const flight = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].flight.findUnique({
            where: {
                id: flightId
            }
        });
        ...
        const existingRating = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].rating.findUnique({
            where: {
                userId_flightId: {
        ...
        if (existingRating) {
            ...
            rating = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].rating.update({
                where: {
            ...
            // Create new rating
            rating = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].rating.create({
                data: {
                    userId: session.user.id,
                    flightId,
                    checkIn: checkIn ?? 0,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0f9f7d90._.js.map